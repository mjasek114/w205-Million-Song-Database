...
SELECT 
	...
	CASE WHEN m.artist_hotttnesss = '' OR m.artist_hotttnesss = 'NA' OR m.artist_hotttnesss = '0.0' THEN NULL ELSE m.artist_hotttnesss END,
	CASE WHEN m.song_hotttnesss = '' OR m.song_hotttnesss = 'NA' OR m.song_hotttnesss = '0.0' THEN NULL ELSE m.song_hotttnesss END,
...
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.OpenCSVSerde'
STORED AS TEXTFILE
LOCATION 's3://w205-mmm/writers';

INSERT OVERWRITE TABLE writers 
SELECT 
	CASE WHEN m.title = '' OR m.title = 'NA' THEN NULL ELSE m.title END,
